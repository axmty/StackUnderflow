...
let createHost () =
  WebHostBuilder()
    ...
    .Configure(Action<IApplicationBuilder> StackUnderflow.Api.App.configureApp)
    .ConfigureServices(Action<IServiceCollection> StackUnderflow.Api.App.configureServices)
